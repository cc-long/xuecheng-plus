    ...
    public void videoJobHandler() throws Exception {
        ...
        mediaProcessList.forEach( mediaProcess -> {
            ...
            executorService.execute(()->{
                ...
                //创建工具类对象
                Mp4VideoUtil videoUtil = new Mp4VideoUtil(ffmpegPath,videoPath,fileId,mp4Path);
                //开始视频转换，成功将返回success
                ...
                //上传到minio
                StringUtils.replace(objectName,".avi",".mp4");
                boolean b1 = mediaFilesService.addMediaFilesToMinIO(mp4Path, "video/mp4", bucket, objectName);
                if (!b1){
